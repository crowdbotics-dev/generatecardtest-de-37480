...
## Project Structure
    ...
    ├── generatecardtest_de_37480  # Django project configurations
...
1. Clone this repo and `cd generatecardtest_de_37480`
...
2. Clone this repo and `cd generatecardtest_de_37480`
